        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item1 in spuSaleAttrList" :key="item1.baseSaleAttrId">
                <dt class="title">{{ item1.saleAttrName }}</dt>
                <dd changepirce="0" v-for="item2 in item1.spuSaleAttrValueList" :key="item2.id"
                  :class="{ active: item2.isChecked == 1 }" @click="changeActive(item1.spuSaleAttrValueList, item2)">{{
